...
class ElementsControllerTest < ActionController::TestCase
  ...
  test "should create element" do
    assert_difference('Element.count') do
      post :create, element: { atm: @element.atm, atnum: @element.atnum, name: @element.name, sign: @element.sign }
    end
  ...
  test "should update element" do
    put :update, id: @element, element: { atm: @element.atm, atnum: @element.atnum, name: @element.name, sign: @element.sign }
    assert_redirected_to element_path(assigns(:element))
  end
